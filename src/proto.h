...
double __cdecl nox_xxx_gamedataGetFloatTable_419D70(void *a1, int a2);
void sub_419DB0();
...
int sub_4238F0();
char *__cdecl set_bitmask_flags_from_plus_separated_names_423930(const char *a1, _DWORD *a2, const char **a3);
int __cdecl set_one_bitmask_flag_by_name_4239C0(char *a1, _DWORD *a2, const char **a3);
...
char *__cdecl nox_xxx_getEnchantName_4248F0(int a1);
...
_DWORD *__cdecl nox_common_list_clear_425760(_DWORD *a1);
...
int *__cdecl nox_common_list_getFirstSafe_425890(int *a1);
int *__cdecl nox_common_list_getNextSafe_4258A0(int *a1);
_DWORD *__cdecl sub_4258C0(_DWORD **a1, int a2);
_DWORD *__cdecl nox_common_list_append_4258E0(int a1, _DWORD *a2);
_DWORD *__cdecl sub_425900(_DWORD *a1, _DWORD *a2);
_DWORD **__cdecl nox_common_list_remove_425920(_DWORD **a1);
int __cdecl nox_common_list_getNext_425940(int *a1);
...
int __cdecl nox_xxx_pointInRect_4281F0(int2 *, int4 *);
...
char *__cdecl nox_xxx_readImgMB_42FAA0(int a1, const char *a2, char *a3);
int sub_42FAD0();
_DWORD *__cdecl sub_42FAE0(int a1);
int __cdecl nox_video_getImagePixdata_42FB30(int a1);
...
int __cdecl nox_client_setMousePos_430B10(int a1, int a2);
int sub_430B30();
int sub_430B40();
...
int __cdecl sub_430C30_set_video_max(int a1, int a2);
int __cdecl nox_xxx_screenGetSize_430C50_get_video_max(_DWORD *a1, _DWORD *a2);
BOOL sub_430CC0();
BOOL sub_430D40();
int sub_430D60();
...
int __cdecl nox_client_addScreenParticle_431680(int a1);
...
void __cdecl nox_draw_splitColor_435280(__int16 a1, _BYTE *a2, _BYTE *a3, _BYTE *a4);
...
BOOL __cdecl nox_client_drawable_testBuff_4356C0(int a1, char a2);
void nox_xxx_spriteLoadError_4356E0();
char *sub_4356F0();
wchar_t *__cdecl sub_435700(wchar_t *a1, int a2);
char *__cdecl nox_client_setServerConnectAddr_435720(char *a1);
DWORD sub_435740();
DWORD sub_435750();
DWORD sub_435770();
DWORD sub_435780();
...
int4 *sub_437180();
int sub_437190();
char *nox_draw_getViewport_437250();
int4 *sub_437260();
int4 *sub_437290();
...
int __cdecl nox_client_setConnError_43AFA0(int a1);
...
char *nox_client_xxx_switchChatMap_43B510();
_DWORD *sub_43B630();
_DWORD *sub_43B670();
int sub_43B6D0();
int sub_43B6E0();
...
int __cdecl nox_sprintAddrPort_43BC80(int a1, unsigned __int16 a2, char *a3);
wchar_t *__cdecl sub_43BCB0(__int16 a1);
int __cdecl sub_43BD90(int a1);
int sub_43BDB0();
void nox_game_decStateInd_43BDC0();
int __cdecl nox_game_addStateCode_43BDD0(int a1);
...
_DWORD *__cdecl nox_xxx_gameGetScreenBoundaries_43BEB0_get_video_mode(_DWORD *a1, _DWORD *a2, _DWORD *a3);
...
_DWORD *sub_43C540();
void __cdecl nox_gui_freeAnimation_43C570(LPVOID lpMem); // idb
_DWORD *__cdecl nox_gui_makeAnimation_43C5B0(_DWORD *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, int a9);
void sub_43C640();
int sub_43C650();
BOOL sub_43C6E0();
...
int __cdecl nox_draw_enableTextSmoothing_43F670(int a1);
...
int __cdecl nox_draw_drawStringHL_43F730(int a1, __int16 *a2, int a3, int a4);
int __cdecl nox_xxx_drawStringStyle_43F7B0(int a1, __int16 *a2, int a3, int a4);
...
int __cdecl nox_xxx_bookDrawString_43FA80_43FD80(int a1, unsigned __int16 *a2, int *a3, _DWORD *a4, int a5);
int __cdecl nox_xxx_drawStringWrap_43FAF0(int a1, _WORD *a2, int a3, int a4, int a5, int a6);
int __cdecl nox_xxx_drawStringWrapHL_43FD00(int a1, _WORD *a2, int a3, int a4, int a5, int a6);
int __cdecl sub_43FD80(int a1, _WORD *a2, int a3, int a4, int a5, int a6);
int __cdecl nox_draw_setTabWidth_43FE20(int a1);
...
int nox_client_clearScreen_440900();
int __cdecl nox_xxx_netServerCmd_440950_empty(char a1, wchar_t *a2);
...
int nox_xxx_quitDialogYes_445B20(); // weak
...
void sub_446380();
FILE *__cdecl nox_motd_4463E0(int a1);
...
int sub_446780();
unsigned int nox_xxx_motd_4467F0();
...
_DWORD *__cdecl nox_xxx_dialogMsgBoxCreate_449A10(int a1, int a2, int a3, int a4, int (*a5)(void), int (*a6)(void));
...
int __cdecl nox_things_cond_animate_draw_parse_44B560(_DWORD *a1, int a2, _BYTE *a3);
...
int __cdecl nox_video_fadeInScreen_44DAB0(int a1, int a2, void (*a3)(void));
int __cdecl nox_video_fadeOutScreen_44DB30(int a1, int a2, int a3);
...
char *sub_44E000();
char *sub_44E020();
int nox_video_stopAllFades_44E040();
int sub_44E070();
int sub_44E090();
int __cdecl sub_44E0B0(int a1);
BOOL nox_video_inFadeTransition_44E0D0();
_DWORD *sub_44E110();
int sub_44E320();
...
int __cdecl nox_gui_setQuestStage_450B00(int a1);
...
BOOL __cdecl nox_thing_skip_AVNT_452B00(int a1);
BOOL __cdecl nox_thing_skip_AVNT_inner_452B30(int a1);
...
int __cdecl nox_xxx_cliRemoveHealthbar_459E30(int a1, char a2);
...
int sub_45A060();
int __cdecl nox_drawable_next_45A070(int a1);
int sub_45A090();
int __cdecl sub_45A0A0(int a1);
int sub_45A0C0();
int __cdecl sub_45A0E0(int a1);
_DWORD *__cdecl nox_xxx_sprite_45A110_drawable(_DWORD *a1);
_DWORD *__cdecl sub_45A160(_DWORD *a1);
BOOL __cdecl sub_45A1D0(int a1);
int sub_45A200();
_DWORD *__cdecl sub_45A240(int a1);
void *sub_45A330();
int __cdecl nox_xxx_spriteLoadAdd_45A360_drawable(int a1, int a2, int a3);
void __cdecl sub_45A480(int a1);
int __cdecl sub_45A4B0(_QWORD *a1);
int __cdecl nox_xxx_spriteDeleteStatic_45A4E0_drawable(int a1);
...
unsigned int nox_client_toggleSpellbook_45AC70();
...
char *__cdecl nox_xxx_abilityReward_45D290(int a1, char *a2, int a3);
...
int __cdecl nox_xxx_bookFillAll_45D570(int a1, int a2);
...
int __cdecl nox_client_invokeSpellSlot_45DA50(int a1);
int __cdecl nox_xxx_clientStoreLastButton_45DAD0(int a1);
int __cdecl nox_xxx_clientSendAbil_45DAF0(int a1);
int __cdecl nox_xxx_clientSendSpell_45DB20(char *a1, int a2, char a3);
int sub_45DB90();
int nox_xxx_guiSpellTargetClickCheckSend_45DBB0();
...
void *sub_4602F0();
void *sub_460380();
_DWORD *nox_client_trapSetNext_4603A0();
_DWORD *nox_client_trapSetPrev_4603F0();
_DWORD *sub_460440();
int __cdecl nox_client_trapSetSelect_4604B0(int a1);
int sub_4604E0();
int nox_client_spellSetNext_4604F0();
int nox_client_spellSetPrev_460540();
int nox_client_spellSetSelect_460590();
int sub_460630();
...
char *sub_461520();
int __cdecl nox_xxx_clientSetAltWeapon_461550(int a1);
int sub_4615C0();
...
int __cdecl nox_xxx_clientUse_465C70(int a1);
int sub_465CA0();
...
char *__cdecl nox_xxx_cliUseCurePoison_4674E0(int a1);
...
int __cdecl nox_client_chatStart_46A430(int a1);
int sub_46A4A0();
...
int __cdecl nox_gui_windowCopyDrawData_46AF80(int a1, const void *a2);
...
int nox_client_getWin1064916_46C720();
int sub_46C730();
...
int __cdecl nox_xxx_cliShowHideTubes_470AA0(int a1);
...
char *nox_client_quickHealthPotion_472220();
char *nox_client_quickManaPotion_472240();
char *nox_client_quickCurePoisonPotion_472260();
wchar_t *sub_472280();
unsigned __int8 *sub_472310();
int nox_client_mapZoomIn_4724E0();
int nox_client_mapZoomOut_472500();
...
int sub_476680();
int __cdecl nox_video_setCutSize_4766A0(int a1);
int nox_video_getCutSize_4766D0();
int sub_4766E0();
int sub_4766F0();
int __cdecl nox_draw_setCutSize_476700(int a1, int a2);
...
int __cdecl nox_client_setPhonemeFrame_476E00(int a1);
_DWORD *sub_476E20();
int sub_476E90();
...
int __cdecl nox_client_tradeXxxSellAccept_4796D0(__int16 a1);
...
int __cdecl nox_draw_imageMeta_47D5C0(int a1, _DWORD *a2, _DWORD *a3, _DWORD *a4, _DWORD *a5);
void nullsub_7(); // weak
...
int *__cdecl nox_xxx_edgeDraw_480EF0(int a1, int a2, int a3, int *a4, int *a5, int a6, int a7, int a8, int a9);
void sub_481410();
int sub_481420();
...
_DWORD *__cdecl nox_gui_newEntryField_488500(int a1, int a2, int a3, int a4, int a5, int a6, int a7, wchar_t *a8);
...
_DWORD *__cdecl nox_gui_newStaticText_489300(int a1, int a2, int a3, int a4, int a5, int a6, _DWORD *a7, _DWORD *a8);
...
int sub_4896E0();
int __cdecl nox_client_screenParticleDraw_489700(int a1, int a2);
int sub_489870();
...
int __cdecl nox_xxx_setSomeFunc_48A210(int a1);
...
unsigned int __cdecl nox_xxx_bookRewardCli_499CF0(int *a1, int a2, int a3);
...
int __cdecl nox_xxx_sprite_49AA00_drawable(_DWORD *a1);
int __cdecl nox_xxx_updateSpritePosition_49AA90(_DWORD *a1, int a2, int a3);
void __cdecl nox_xxx_forEachSprite_49AB00(int4 *, void (__cdecl *)(int, int), int);
_DWORD *__cdecl nox_drawable_find_49ABF0(_DWORD *a1, int a2);
...
int __cdecl nox_xxx_clientRemoveRayEffect_49C450(int a1);
void nox_xxx_spriteDeleteSomeList_49C4B0();
int nox_xxx_sprite_49C4F0();
...
int __cdecl nox_client_drawPixel_49EFA0(int a1, int a2);
...
int4 *__cdecl sub_49F7C0_def(int a1);
...
char *sub_4A0020();
int __cdecl nox_wol_servers_addResult_4A0030(const void *a1);
int __cdecl nox_wol_servers_sortBtnHandler_4A0290(int a1);
...
int __cdecl nox_gui_newButtonOrCheckbox_4A91A0(int a1, int a2, int a3, int a4, int a5, int a6, _DWORD *a7);
...
int __cdecl nox_xxx_spriteLoadFromMap_4AC020(int a1, __int16 a2, _DWORD *a3);
...
int __cdecl nox_thing_particle_draw_4AFE80(int a1, _DWORD *a2);
...
int __cdecl nox_client_drawPoint_4B0BC0(int a1, int a2, int a3);
...
_DWORD *__cdecl nox_gui_newSlider_4B4EE0(int a1, int a2, int a3, int a4, int a5, int a6, _DWORD *a7, float *a8);
...
int sub_4B5CD0();
int __cdecl nox_thing_magic_tail_link_draw_4B5E10(_DWORD *a1, int a2);
int __cdecl nox_thing_magic_missle_tail_link_draw_4B5F30(_DWORD *a1, int a2);
int __cdecl sub_4B6050(_DWORD *a1, int a2);
int __cdecl sub_4B6120(_DWORD *a1, int a2);
int __cdecl nox_thing_harpoon_rope_draw_4B61F0(int *a1, int a2);
int __cdecl sub_4B63B0(int2 *a1, int2 *a2); // idb
int __cdecl nox_thing_harpoon_draw_4B64A0(int *a1, int a2);
int sub_4B64C0();
...
int __cdecl nox_thing_red_spark_draw_4B6A60(_DWORD *a1, int a2);
int __cdecl nox_thing_blue_spark_draw_4B6A80(_DWORD *a1, int a2);
int __cdecl nox_thing_cyan_spark_draw_4B6AA0(_DWORD *a1, int a2);
int __cdecl nox_thing_green_spark_draw_4B6AC0(_DWORD *a1, int a2);
int __cdecl nox_thing_yellow_spark_draw_4B6AE0(_DWORD *a1, int a2);
int __cdecl nox_thing_magic_sparkle_draw_4B6B00(int *a1, int a2);
int __cdecl nox_thing_glow_orb_draw_4B6B60(int *a1, int a2);
int __cdecl sub_4B6B80(int *a1, int a2, int a3);
int __cdecl nox_thing_glow_orb_move_draw_4B6E20(int *a1, int a2);
int __cdecl nox_thing_violet_spark_draw_4B6E40(_DWORD *a1, int a2);
int __cdecl nox_thing_death_ball_spark_draw_4B6E60(_DWORD *a1, int a2);
int __cdecl nox_thing_pixie_draw_4B6E80(int *a1, int a2);
int __cdecl nox_thing_pixie_dust_draw_4B6FE0(int *a1, int a2);
int __cdecl nox_thing_white_spark_draw_4B7040(_DWORD *a1, int a2);
int __cdecl nox_thing_blue_rain_spark_draw_4B7060(_DWORD *a1, int a2);
int __cdecl sub_4B71A0(_DWORD *a1, int a2);
int __cdecl nox_thing_rain_orb_draw_4B7310(_DWORD *a1, int a2);
int __cdecl nox_thing_bubble_draw_4B7540(_DWORD *a1, int a2);
int __cdecl nox_thing_levelup_draw_4B7700(int a1, int a2);
_DWORD *__cdecl nox_thing_falling_sparks_draw_4B7740(int a1, int a2, int a3);
int __cdecl nox_thing_oblivion_up_draw_4B77D0(int a1, int a2);
int __cdecl nox_thing_blue_rain_draw_4B7810(int a1, int a2);
int __cdecl nox_thing_arrow_draw_4B7920(int *a1, _DWORD *a2);
int __cdecl sub_4B79D0(int *a1, _DWORD *a2);
int __cdecl nox_thing_undead_killer_draw_4B7A80(_DWORD *a1, int a2);
...
int __cdecl nox_thing_summon_effect_draw_4B7D00(int *a1, _DWORD *a2);
...
int __cdecl nox_thing_flag_draw_4B9500(int *a1, int a2);
int __cdecl nox_thing_base_draw_4B95B0(int *a1, int a2);
_DWORD *__cdecl sub_4B95D0(int a1);
_DWORD *__cdecl sub_4B9650(int a1);
int __cdecl nox_thing_weapon_draw_4B9690(int *a1, int a2);
int __cdecl sub_4B96B0(int *a1, int a2);
int __cdecl nox_thing_armor_draw_4B96D0(int *a1, int a2);
_DWORD *__cdecl sub_4B96F0(int a1);
int __cdecl nox_thing_armor_animate_draw_4B9770(int *a1, int a2);
int __cdecl nox_thing_player_waypoint_draw_4B9790(int a1, int a2);
int __cdecl nox_thing_magic_draw_4B98A0(int *a1, int a2);
int __cdecl nox_thing_magic_missle_draw_4B99F0(int *a1, int a2);
int nox_thing_drain_mana_draw_4B9B40();
int __cdecl nox_thing_boulder_draw_4B9B50(int *a1, int a2);
int __cdecl nox_thing_glyph_draw_4B9C70(int *a1, _DWORD *a2);
int __cdecl nox_thing_spider_spit_draw_4B9D70(_DWORD *a1, int a2);
int __cdecl nox_thing_black_powder_draw_4B9ED0(_DWORD *a1, int a2);
int __cdecl nox_thing_vortex_draw_4B9F50(int *a1, int a2);
...
int __cdecl nox_thing_plasma_draw_4BA980(int *a1, int a2);
int nox_xxx_prepareLightningEffects_4BAB30();
int __cdecl nox_thing_lightning_draw_4BAC80(int *a1, int a2);
...
int __cdecl nox_thing_trigger_draw_4BB9D0(_DWORD *a1, int a2);
int __cdecl nox_thing_pressure_plate_draw_4BBB30(_DWORD *a1, int a2);
int __cdecl nox_thing_slave_draw_4BBD30(int *a1, int a2);
int __cdecl nox_thing_animate_draw_4BBD60(int *a1, int a2);
int __cdecl sub_4BBF10(int *a1, _DWORD *a2);
int __cdecl nox_thing_monster_draw_4BBF90(int *a1, int a2);
...
int __cdecl nox_thing_monster_gen_draw_4BC750(int *a1, int a2);
int nox_xxx_updDrawMonsterGen_4BC920();
int __cdecl nox_thing_cond_animate_draw_4BC930(int *a1, int a2);
int __cdecl nox_thing_door_draw_4BC9E0(int *a1, int a2);
int __cdecl nox_thing_static_draw_4BCC20(int *a1, int a2);
...
int nox_gui_itemAmount_free_4C03E0();
int __cdecl nox_gui_itemAmountDialog_4C0430(int a1, int a2, int a3, int a4, int a5, const void *a6, int a7, int a8, int a9, int a10);
...
BOOL sub_4C3260();
int __cdecl nox_video_drawCircleColored_4C3270(int a1, int a2, int a3, int a4);
...
__int16 __cdecl nox_xxx_drawObject_4C4770_draw(int *a1, unsigned __int8 *a2, int a3);
...
_DWORD *__cdecl nox_gui_newProgressBar_4CAF10(int a1, int a2, int a3, int a4, int a5, int a6, _DWORD *a7);
...
_DWORD *nox_client_advVideoOptsLoad_4CB330();
int __cdecl nox_client_advVideoOpts_New_4CB590(int a1);
...
void __cdecl fireball_4CCEA0(_DWORD *a1, int a2);
...
void __cdecl charm_up_4CD150(int a1, _DWORD *a2, int a3, int a4);
int __cdecl sub_4CD400(_DWORD *a1, int a2);
int __cdecl healup_4CD450(_DWORD *a1, int a2);
int __cdecl drain_up_4CD690(_DWORD *a1, int a2);
...
int __cdecl cloud_4CE200(int a1, int a2, int a3, int a4);
...
int sub_4CFE00();
int __cdecl nox_common_checkMapFile_4CFE10(const char *a1);
int __cdecl nox_mapToGameFlags_4CFF50(int a1);
...
HANDLE sub_4D07F0();
int *nox_common_maplist_free_4D0970();
int *nox_common_maplist_first_4D09B0();
int *__cdecl nox_common_maplist_next_4D09C0(int *a1);
...
int __cdecl nox_xxx_mapSwitchLevel_4D12E0(int a1);
void sub_4D15B0();
void sub_4D15C0();
int sub_4D15D0();
void sub_4D15E0();
...
char *sub_4D6940();
char *sub_4D6950();
int __cdecl nox_game_sendQuestStage_4D6960(int a1);
...
int __cdecl nox_xxx_setQuest_4D6F60(int a1);
int sub_4D6F70();
...
int __cdecl nox_server_questNextStageThreshold_4D74F0(int a1);
char __cdecl sub_4D7520(int a1);
int sub_4D75E0();
int __cdecl sub_4D75F0(int a1);
int nox_server_checkWarpGate_4D7600();
...
int __cdecl nox_xxx_netFlagWinner_4D8C40_4D8C80(int a1);
...
int __cdecl nox_set_server_objects_4DA3E0(int a1);
...
char __cdecl nox_xxx_createAt_4DAA50(int a1, int a2, float a3, float a4); // idb
...
int sub_4DB0A0();
int sub_4DB100();
unsigned int __cdecl nox_setSaveFileName_4DB130(const char *a1);
...
_DWORD *__cdecl nox_xxx_newObjectWithTypeInd_4E3450(int a1);
_DWORD *__cdecl sub_4E3470(int a1);
_DWORD *__cdecl nox_xxx_newObjectByTypeID_4E3810(CHAR *a1);
...
int __cdecl nox_game_setQuestStage_4E3CD0(int a1);
...
int __cdecl nox_object_getInitData_4E4C30(int a1);
...
int __cdecl nox_net_importantACK_4E55A0(unsigned __int8 a1, int a2);
...
char *__cdecl nox_xxx_spawnSomeBarrel_4E7470(int a1, int a2);
...
void __cdecl nox_xxx_unitSetOwner_4EC290(int a1, int a2);
...
int __cdecl nox_GlyphDrop_4ED500(int a1, int a2, float2 *a3); // idb
...
char *__cdecl nox_xxx_set_god_4EF500(int a1);
void sub_4EF560();
void sub_4EF570();
...
int __cdecl nox_xxx_spellAwardAll2_4EFC80(int a1);
int __cdecl nox_xxx_spellAwardAll1_4EFD80(int a1);
char __cdecl nox_xxx_spellAwardAll3_4EFE10(int a1);
...
_DWORD *__cdecl nox_object_setGold_4FA620(int a1, int a2);
int __cdecl nox_xxx_playerGetGold_4FA6B0(int a1);
int __cdecl nox_object_getGold_4FA6D0(int a1);
...
void __cdecl nox_xxx_teleportAllPixies_4FD090(int a1);
...
int __cdecl nox_xxx_collide_4FDF90(int a1, int a2);
...
int sub_500A60();
int sub_500B70();
int __cdecl nox_xxx_orderUnitLocal_500C70(int a1, int a2);
...
void __cdecl nox_xxx_banishUnit_5017F0(int a1);
int sub_501860();
void sub_5018D0();
...
int sub_5098A0();
int sub_5099B0();
char nox_server_checkVictory_509A60();
...
int *__cdecl nox_xxx_monsterPushAction_50A260_impl(int a1, int a2);
...
int __cdecl nox_xxx_unitUpdateMonster_50A5C0(void *p);
void __cdecl nox_xxx_unitUpdateSightMB_5281F0(void *self);
...
int sub_515700();
int sub_515780();
void __cdecl nox_xxx_unitHunt_5157A0(int a1);
int sub_5157D0();
int sub_515800();
void __cdecl nox_xxx_unitIdle_515820(int a1);
int sub_515850();
int sub_515880();
...
void __cdecl nox_xxx_unitsGetInCircle_517F90(float2 *a1, float a2, void *a3, int a4); // idb
void __cdecl sub_518000(float *, int); // idb
int __cdecl sub_518040(int, float, int, int); // idb
void __cdecl sub_5180B0(int a1, int a2);
void __cdecl nox_xxx_getMissilesInCircle_518170(int a1, float a2, int a3, int a4);
...
int __cdecl nox_xxx_playerResetControlBuffer_51AC30(int a1);
...
int __cdecl nox_xxx_sendGeneratorBreakFX_523200(float *a1, char a2);
...
int __cdecl nox_xxx_sendGeneratorSpawnFX_523830(int4 *a1, __int16 a2); // idb
int __cdecl nox_xxx_sendArrowTrapFX_5238A0(float *a1, char a2);
...
size_t __cdecl nox_xxx_XFer_WriteShopItem_52A5F0(int a1);
...
int __cdecl nox_xxx_spellDrainMana_52E210(void *p); // idb
...
void __cdecl nox_xxx_spellEnergyBoltSetTarget_52EC60(int a1, int a2);
...
int __cdecl nox_xxx_onFrameLightning_52F8A0(void *p); // idb
void __cdecl nox_xxx_lightningCanAttackCheck_52FF10(int a1, int a2);
_DWORD *__cdecl sub_52FFD0(int a1, int a2, int a3);
void __cdecl nox_xxx_lightningSpellTrapEffect_530020(int a1, int a2);
...
char __cdecl nox_ai_action_pop_532100(int a1);
...
int __cdecl nox_xxx_enemyAggro_5335D0(int, float); // idb
...
void __cdecl nox_xxx_enactUnitOrder_5339A0(int a1, int a2, int a3);
...
int (__cdecl *__cdecl nox_xxx_mobGenericDeath_544C40(int a1))(int);
void __cdecl nox_xxx_zombieBurnDeleteCheck_544CA0(_DWORD *a1);
...
char __cdecl nox_xxx_createReleasedSoul_544E60(int a1);
...
int __cdecl nox_xxx_strikeScorpion_5495B0(void *p); // idb
BOOL __cdecl sub_549690(int a1, int a2);
int __cdecl nox_xxx_strikeVileZombie_549700(void *p); // idb
int __cdecl nox_xxx_strikeStoneGolem_5497E0(void *p);
int __cdecl nox_xxx_sendEquakeAfterGolem_549800(void *p); // idb
void __cdecl nox_xxx_monsterAttackAreaDamage_549860(int a1, void *p2);
int __cdecl nox_xxx_strikeMechGolem_549960(void *p); // idb
int __cdecl nox_xxx_strikeWasp_549980(void *p); // idb
int __cdecl nox_xxx_strikeGhost_549A60(void *p); // idb
int nox_xxx_strikeBomber_549BB0();
int __cdecl nox_xxx_strikeSpider_549BC0(void *p); // idb
int __cdecl nox_xxx_strikeSpittingSpider_549CA0(void *p); // idb
...
void sub_554B30();
int __cdecl nox_xxx_createSocketLocal_554B40(u_short hostshort); // idb
